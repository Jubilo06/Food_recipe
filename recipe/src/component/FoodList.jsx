...
function FoodList(){
    ...
    return(
        <Stack  direction="row" data-aos='zoom-in' flexWrap='wrap' height='auto' width='100%' sx={{backgroundColor:"#F7E2D8"}}>
            ...
            <Stack width="100%" data-aos='zoom-in' justifyContent={{xs:'center', sm:'space-around', md:'space-between'}}  direction="row"  p={2} flexWrap='wrap' height='auto'>
                {foodData.map((food)=> 
                    <Stack className={styles.foodstack} key={food.id} my={2} 
                    width={{xs:'90%', sm:"40%", md:'25%'}} height="500px" backgroundColor='#FFFDF2' >
