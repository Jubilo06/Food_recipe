  ...
  return (
    <Stack className={styles.recipestack} backgroundColor='#DE8c63'  data-aos='zoom-in'>
      <Stack direction="column" spacing={2}>
        <Typography textAlign='center' fontWeight={900} pt={4} variant="h3" sx={{ color: "black" }}>
          {food.title}
        </Typography>
        <img
          src={food.image}
      ...
      <Stack>
        <Typography fontWeight={900} pt={4} pb={4} textAlign="center" variant="h3" sx={{ color: "black" }}>
          <strong>Ingredients</strong>
        </Typography>
        <Stack  spacing={{xs:0,sm:'initial', md:'initial'}} direction="row" justifyContent={{xs:'center', sm:'space-evenly', md:'space-between'}} flexWrap='wrap' height='auto' width='100%' 
